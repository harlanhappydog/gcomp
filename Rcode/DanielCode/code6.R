...
testing<-function(n, a_, a0_a1, l1_a1, a0_l1, u_=0, h_=0){
...
print("Sparse?")
print(sum(c(unlist(table(simdata_obs)))<3))
...
standard_A1_onesidepval<-(1-pnorm(coef(summary(glmmod1))[2,3]))
...
g_effect_onesidepval	= g_effect_onesidepval,
