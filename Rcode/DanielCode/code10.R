...
testing(1, a_=0, a0_a1=0, l1_a1=1, a0_l1=logit(0.5-0.305), u_=(2), h_=2.5)
...
# All direct effect  ( a0_y, a1_y):
testing(100, a_=logit(0.5+0.0375), a0_a1=0, l1_a1=1, a0_l1=logit(0.5-0.305), u_=0, h_=2.5, l1_y=0)$true_effect

# All indirect effect  even transition
testing(100, a_=NA, a0_a1=0, l1_a1=1, a0_l1=logit(0.5-0.255), u_=0, h_=2.5, a0_y = 0, a1_y =  0, l1_y=logit(0.5-0.255))$true_effect

# All indirect effect uneven transition
testing(100, a_=NA, a0_a1=0, l1_a1=1, a0_l1=2*logit(0.5-0.259), u_=0, h_=2.5, a0_y = 0, a1_y =  0, l1_y=0.51*logit(0.5-0.259))$true_effect

# All indirect effect uneven transition
testing(100, a_=NA, a0_a1=0, l1_a1=1, a0_l1=0.50*logit(0.5-0.2565), u_=0, h_=2.5, a0_y = 0, a1_y =  0, l1_y=2.1*logit(0.5-0.2565))$true_effect
