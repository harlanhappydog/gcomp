...
print("Sparse?")
print(sum(c(unlist(table(simdata)))<5))
...
standard_effect<-coef(summary(glmmod))[2:3,c(1,4)]
...
return(list(true_effect= true_effect, g_effect= g_effect, iv_pval= iv_pval, standard_effect= standard_effect))}
####################################################################### 
####################################################################### 
####################################################################### 

# Standard method fails, g-comp provides unbiased result  (true effect is 0.156):
testing(500, 5, 0, -5, 5, -5)
