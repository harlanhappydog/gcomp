...
Fgammas_wY1_H[Fgammas_wY1_H$cond=="C2" & Fgammas_wY1_H$H== h1i  & Fgammas_wY1_H$C2== c2i  & Fgammas_wY1_H$C1== c1i  & Fgammas_wY1_H$X1== x1i,]$gamma<-C2prob(h1i, c2i, c1i, x1i)
 ...
 Fgammas_wY1_H[Fgammas_wY1_H$cond=="Y2"& gammas_wY1_H$H== h1i  & Fgammas_wY1_H$Y2== y2i & Fgammas_wY1_H$C1== c1i   & Fgammas_wY1_H$C2== c2i  & Fgammas_wY1_H$X2== x2i  & Fgammas_wY1_H$X1== x1i,]$gamma<-Y2prob(h1i, y2i, c1i, c2i, x1i, x2i)  
}}}}
...
Y2prob<-function(h1,y2,c2,x1,x2, y1){
pp<-predict(glm(Y2~1,data=simdata[simdata$C2==c2 & simdata$X2==x2 & simdata$X1==x1   & simdata$H==h1 & simdata$Y1==y1, ], family="binomial"), newdata=data.frame(X="ZZ"),type="response")
if(y2==0){return(1-as.numeric(pp))}
if(y2==1){return(as.numeric(pp))}}
...
Fgammas_Y1_H[Fgammas_Y1_H$cond=="C2" & Fgammas_Y1_H$H== h1i  & Fgammas_Y1_H$C2== c2i  & Fgammas_Y1_H$C1== c1i  & Fgammas_Y1_H$X1== x1i,]$gamma<-C2prob(h1i, c2i, c1i, x1i)
 Fgammas_Y1_H[Fgammas_Y1_H$cond=="Y2"& gammas_Y1_H$H== h1i  & Fgammas_Y1_H$Y2== y2i  & Fgammas_Y1_H$C2== c2i  & Fgammas_Y1_H$X2== x2i  & Fgammas_Y1_H$X1== x1i & Fgammas_Y1_H$Y1== y1i,]$gamma<-Y2prob(h1i, y2i, c2i, x1i, x2i, y1i)  
}}}}
