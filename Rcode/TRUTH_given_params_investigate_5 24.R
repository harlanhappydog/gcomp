...
numsim <- 1000  														### number of datasets generated under each scenario
n <- 1000  																	### size of each dataset
set.seed(13)  																### for reproducibility
nB<-25																		### number of MC samples
...
gammas_wY1_wH[gammas_wY1_wH$cond=="C2" & gammas_wY1_wH$C1== c1i & gammas_wY1_wH$C2== c2i &
 gammas_wY1_wH$X1== x1i,]$gamma<-C2probB(c1i,c2i,x1i)

gammas_wY1_wH[gammas_wY1_wH$cond=="Y2" & gammas_wY1_wH$C1== c1i & gammas_wY1_wH$C2== c2i &
 gammas_wY1_wH$X1== x1i  & gammas_wY1_wH$X2== x2i  & gammas_wY1_wH$Y2== y2i,]$gamma<-Y2probB(y2i, c1i, c2i, x1i, x2i)
}
}
}
...
# # print('FREQUENTIST APPROACH WITHOUT Y1 WITHOUT H')
# Fgammas_wY1_wH<-data.frame(expand.grid(c(0,1),c(0,1),c(0,1),c(0,1),c(0,1),c(0,1),c(1), c("H","C1","C2","Y1","Y2"), c(NA)))
# colnames(Fgammas_wY1_wH)<-c("H","C1","C2","X1","X2","Y1","Y2", "cond", "gamma")
...
# Y2prob<-function(y2,c2,x1,x2){
# pp<-predict(glm(Y2~1,data=simdata[simdata$C2==c2 & simdata$X2==x2 & simdata$X1 == x1, ], family="binomial"), newdata=data.frame(X="ZZ"),type="response")
# if(y2==0){return(1-as.numeric(pp))}
# if(y2==1){return(as.numeric(pp))}}
...
# x1i<-x2i
      # for (c2i in 0:1) {
            # for (c1i in 0:1) {
# Fgammas_wY1_wH[Fgammas_wY1_wH$cond=="C1" & Fgammas_wY1_wH$C1== c1i,]$gamma<-C1prob(c1i)	
# Fgammas_wY1_wH[Fgammas_wY1_wH$cond=="C2" & Fgammas_wY1_wH$C2== c2i  & Fgammas_wY1_wH$C1== c1i  & Fgammas_wY1_wH$X1== x1i,]$gamma<-C2prob(c2i, c1i, x1i)
# Fgammas_wY1_wH[Fgammas_wY1_wH$cond=="Y2" & Fgammas_wY1_wH$Y2== y2i  & Fgammas_wY1_wH$C2== c2i  & Fgammas_wY1_wH$X2== x2i  & Fgammas_wY1_wH$X1== x1i,]$gamma<-Y2prob(y2i, c2i, x1i,x2i)
# }}}
...
# for(c2i in 0:1){
# for(c1i in 0:1){
# sumtheta11<-sumtheta11+unique(Fgammas_wY1_wH[Fgammas_wY1_wH$cond=="C1" & Fgammas_wY1_wH$C1== c1i,]$gamma*
# Fgammas_wY1_wH[Fgammas_wY1_wH$cond=="C2" & Fgammas_wY1_wH$C2== c2i  & Fgammas_wY1_wH$C1== c1i  & Fgammas_wY1_wH$X1== x1i,]$gamma*
# Fgammas_wY1_wH[Fgammas_wY1_wH$cond=="Y2" & Fgammas_wY1_wH$Y2== y2i  & Fgammas_wY1_wH$C2== c2i  & Fgammas_wY1_wH$X2== x2i  & Fgammas_wY1_wH$X1== x1i,]$gamma)
# }}
        # x1i<-0
        # x2i<-0
        # y2i<-1
...
# for(c2i in 0:1){
# for(c1i in 0:1){
# sumtheta00<-sumtheta00 +unique(Fgammas_wY1_wH[Fgammas_wY1_wH$cond=="C1" & Fgammas_wY1_wH$C1== c1i,]$gamma*
# Fgammas_wY1_wH[Fgammas_wY1_wH$cond=="C2" & Fgammas_wY1_wH$C2== c2i  & Fgammas_wY1_wH$C1== c1i  & Fgammas_wY1_wH$X1== x1i,]$gamma*
# Fgammas_wY1_wH[Fgammas_wY1_wH$cond=="Y2" & Fgammas_wY1_wH$Y2== y2i  & Fgammas_wY1_wH$C2== c2i  & Fgammas_wY1_wH$X2== x2i  & Fgammas_wY1_wH$X1== x1i,]$gamma)
# }}

# print(c(mean(sumtheta00Bvec_wY1_wH ), sumtheta00))
# print(c(mean(sumtheta11Bvec_wY1_wH ), sumtheta11))
...
gammas_wY1_H[gammas_wY1_H$cond=="C2" & gammas_wY1_H$H== h1i & gammas_wY1_H$C2== c2i  & gammas_wY1_H$C1== c1i  & gammas_wY1_H$X1== x1i,]$gamma<-C2probB(h1i, c2i, c1i, x1i)
 ...
 gammas_wY1_H[gammas_wY1_H$cond=="Y2" & gammas_wY1_H$H== h1i  & gammas_wY1_H$Y2== y2i & gammas_wY1_H$C1== c1i   & gammas_wY1_H$C2== c2i  & gammas_wY1_H$X2== x2i  & gammas_wY1_H$X1== x1i,]$gamma<-Y2probB(h1i, y2i, c1i, c2i, x1i, x2i)       
 }}}}
...
# #  print('FREQUENTIST APPROACH WITHOUT Y1 WITH H')
# Fgammas_wY1_H<-data.frame(expand.grid(c(0,1),c(0,1),c(0,1),c(0,1),c(0,1),c(0,1),c(1), c("H","C1","C2","Y1","Y2"), c(NA)))
# colnames(Fgammas_wY1_H)<-c("H","C1","C2","X1","X2","Y1","Y2", "cond", "gamma")
...
# Y2prob<-function(h1,y2,c1,c2,x1,x2){
# pp<-predict(glm(Y2~1,data=simdata[simdata$C2==c2 & simdata$C1==c1 & simdata$X2==x2 & simdata$X1==x1   & simdata$H==h1, ], family="binomial"), newdata=data.frame(X="ZZ"),type="response")
# if(y2==0){return(1-as.numeric(pp))}
# if(y2==1){return(as.numeric(pp))}}
...
# x1i<-x2i
      # for (c2i in 0:1) {
     	 # for (h1i in 0:1) {
            # for (c1i in 0:1) {
# Fgammas_wY1_H[Fgammas_wY1_H$cond=="H" & Fgammas_wY1_H$H== h1i,]$gamma<-Hprob(h1i)	

# Fgammas_wY1_H[Fgammas_wY1_H$cond=="C1" & Fgammas_wY1_H$C1== c1i & Fgammas_wY1_H$H== h1i,]$gamma<-C1prob(h1i ,c1i)	
	
# Fgammas_wY1_H[Fgammas_wY1_H$cond=="C2" & Fgammas_wY1_H$H== h1i  & Fgammas_wY1_H$C2== c2i  & Fgammas_wY1_H$C1== c1i  & Fgammas_wY1_H$X1== x1i,]$gamma<-C2prob(h1i, c2i, c1i, x1i)

 # Fgammas_wY1_H[Fgammas_wY1_H$cond=="Y2"& Fgammas_wY1_H$H== h1i  & Fgammas_wY1_H$Y2== y2i & Fgammas_wY1_H$C1== c1i   & Fgammas_wY1_H$C2== c2i  & Fgammas_wY1_H$X2== x2i  & Fgammas_wY1_H$X1== x1i,]$gamma<-Y2prob(h1i, y2i, c1i, c2i, x1i, x2i)  
# }}}}
...
# Fgammas_wY1_H[Fgammas_wY1_H$cond=="H" & Fgammas_wY1_H$H== h1i,]$gamma*
# Fgammas_wY1_H[Fgammas_wY1_H$cond=="C1" & Fgammas_wY1_H$H== h1i  & Fgammas_wY1_H$C1== c1i,]$gamma*
# Fgammas_wY1_H[Fgammas_wY1_H$cond=="C2"& Fgammas_wY1_H$H== h1i  & Fgammas_wY1_H$C2== c2i  & Fgammas_wY1_H$C1== c1i  & Fgammas_wY1_H$X1== x1i,]$gamma*
 # Fgammas_wY1_H[Fgammas_wY1_H$cond=="Y2" & Fgammas_wY1_H$H== h1i & Fgammas_wY1_H$Y2== y2i & Fgammas_wY1_H$C1== c1i   & Fgammas_wY1_H$C2== c2i  & Fgammas_wY1_H$X2== x2i  & Fgammas_wY1_H$X1== x1i,]$gamma)
# }}}
        # x1i<-0
        # x2i<-0
        # y2i<-1
...
# for(h1i in 0:1){
# for(c1i in 0:1){
# sumtheta00<-sumtheta00 +unique(
# Fgammas_wY1_H[Fgammas_wY1_H$cond=="H" & Fgammas_wY1_H$H== h1i,]$gamma*
# Fgammas_wY1_H[Fgammas_wY1_H$cond=="C1" & Fgammas_wY1_H$H== h1i  & Fgammas_wY1_H$C1== c1i,]$gamma*
# Fgammas_wY1_H[Fgammas_wY1_H$cond=="C2"& Fgammas_wY1_H$H== h1i  & Fgammas_wY1_H$C2== c2i  & Fgammas_wY1_H$C1== c1i  & Fgammas_wY1_H$X1== x1i,]$gamma*
 # Fgammas_wY1_H[Fgammas_wY1_H$cond=="Y2" & gammas_wY1_H$H== h1i & Fgammas_wY1_H$Y2== y2i & Fgammas_wY1_H$C1== c1i   & Fgammas_wY1_H$C2== c2i  & Fgammas_wY1_H$X2== x2i  & Fgammas_wY1_H$X1== x1i,]$gamma)
# }}}
# sumtheta00
# sumtheta11
# print(c(mean(sumtheta00Bvec_wY1_H ), sumtheta00))
# print(c(mean(sumtheta11Bvec_wY1_H ), sumtheta11))
 # my_Fgammas_wY1_H[[i]][,j]<-Fgammas_wY1_H[,9]  
...
# print(c(mean(sumtheta11Bvec_Y1_H ), sumtheta11))
 # my_Fgammas_Y1_H[[i]][,j]<-Fgammas_Y1_H[,9]  
...
#one-sided p-values:
        Bpval_wY1_wH <- 1 - mean((sumtheta11Bvec_wY1_wH - sumtheta00Bvec_wY1_wH) > 0)
         ...
         kkk <- kkk + 1
    	   ...
    	   true_gammas[[i]]$Fsimgamma_wY1_wH<-rowMeans(my_Fgammas_wY1_wH[[i]][,1:j])   
...
true_gammas[[1]]$Y2avg<-0
true_gammas[[1]][true_gammas[[1]]$cond=="Y2"  & true_gammas[[1]]$C1==0,]$Y2avg<-c(
c(table(simdata[simdata$C1==0,]$Y1)/sum(table(simdata[simdata$C1==0,]$Y1)))%*%rbind(true_gammas[[1]][true_gammas[[1]]$cond=="Y2" & true_gammas[[1]]$Y1==0 & true_gammas[[1]]$C1==0,]$gamma,true_gammas[[1]][true_gammas[[1]]$cond=="Y2" &true_gammas[[1]]$Y1==1,]$gamma))

true_gammas[[1]][true_gammas[[1]]$cond=="Y2"  & true_gammas[[1]]$C1==1,]$Y2avg<-c(
c(table(simdata[simdata$C1==1,]$Y1)/sum(table(simdata[simdata$C1==1,]$Y1)))%*%rbind(true_gammas[[1]][true_gammas[[1]]$cond=="Y2" & true_gammas[[1]]$Y1==0 & true_gammas[[1]]$C1==1,]$gamma,true_gammas[[1]][true_gammas[[1]]$cond=="Y2" &true_gammas[[1]]$Y1==1,]$gamma))

na.omit(subset(true_gammas[[1]][,-c(12:17)], !duplicated(true_gammas[[1]][,-c(12:17)][,10])))

na.omit(subset(true_gammas[[1]][,-c(10,11,14:17)], !duplicated(true_gammas[[1]][,-c(10,11,14:17)][,10])))

na.omit(subset(true_gammas[[1]][,-c(10,11,12,13,16,17)], !duplicated(true_gammas[[1]][,-c(10,11,12,13,16,17)][,10])))

na.omit(subset(true_gammas[[1]][,-c(10,11,12,13,14,15)], !duplicated(true_gammas[[1]][,-c(10,11,12,13,14,15)][,10])))
