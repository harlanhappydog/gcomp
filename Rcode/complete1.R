...
checkmat<-function(mat){
	data.frame("error"=round(apply(cbind(abs(mat[,dim(mat)[2]]-mat$gamma),	(mat[,dim(mat)[2]]-mat$Y2avg)),1, min),2))	
}
...
save(true_gammas, file="~/Documents/gcomp/Rcode/results/true_gammas_n1000.rda")
save(Bayesresult, file="~/Documents/gcomp/Rcode/results/Bayesresult_n1000.rda")
save(power, file="~/Documents/gcomp/Rcode/results/power_n1000.rda")
