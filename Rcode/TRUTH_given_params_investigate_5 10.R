...
gammas_wY1_wH[[i]]<-data.frame(expand.grid(c(0,1),c(0,1),c(0,1),c(0,1),c(0,1),c(0,1),c(1), c("H","C1","C2","Y1","Y2"), c(NA)))
colnames(gammas_wY1_wH[[i]])<-c("H","C1","C2","X1","X2","Y1","Y2", "cond", "gamma")
gammas<-matrix(0,dim(gammas_wY1_wH[[i]])[1], nB)
for(sw in 1:nB){
...
gammas_wY1_wH[[i]][gammas_wY1_wH[[i]]$cond=="Y2" & gammas_wY1_wH[[i]]$C1== c1i & gammas_wY1_wH[[i]]$C2== c2i & gammas_wY1_wH[[i]]$X1== x1i  & gammas_wY1_wH[[i]]$X2== x2i  & gammas_wY1_wH[[i]]$Y2== y2i,]$gamma<-Y2probB(  y2i, c1i, c2i, x1i, x2i)
}
}
}
}
...
unique(gammas_wY1_wH[[i]][gammas_wY1_wH[[i]]$cond=="C1" & gammas_wY1_wH[[i]]$C1== c1i,]$gamma*
gammas_wY1_wH[[i]][gammas_wY1_wH[[i]]$cond=="C2" & gammas_wY1_wH[[i]]$C1== c1i & gammas_wY1_wH[[i]]$C2== c2i & gammas_wY1_wH[[i]]$X1== x1i,]$gamma*
gammas_wY1_wH[[i]][gammas_wY1_wH[[i]]$cond=="Y2" & gammas_wY1_wH[[i]]$C1== c1i & gammas_wY1_wH[[i]]$C2== c2i & gammas_wY1_wH[[i]]$X1== x1i  & gammas_wY1_wH[[i]]$X2== x2i  & gammas_wY1_wH[[i]]$Y2== y2i,]$gamma)
}}
...
gammas[,sw]<-gammas_wY1_wH[[i]]$gamma
}
...
sumtheta00Bvec<-rep(0,nB)
gammas_Y1_wH<-list()
gammas_Y1_wH[[i]]<-data.frame(expand.grid(c(0,1),c(0,1),c(0,1),c(0,1),c(0,1),c(0,1),c(1), c("H","C1","C2","Y1","Y2"), c(NA)))
colnames(gammas_Y1_wH[[i]])<-c("H","C1","C2","X1","X2","Y1","Y2", "cond", "gamma")

gammas<-matrix(0,dim(gammas_Y1_wH[[i]])[1], nB)
...
C1probB<-function(c1,nm=1){
	...
	if(c1==0){return(1-as.numeric(pp))}
	if(c1==1){return(as.numeric(pp))}}
gammas_Y1_wH[[i]][gammas_Y1_wH[[i]]$cond=="C1" & gammas_Y1_wH[[i]]$C1== c1i,]$gamma<-C1probB(c1i)	
...
gammas_Y1_wH[[i]][gammas_Y1_wH[[i]]$cond=="Y1" & gammas_Y1_wH[[i]]$Y1== y1i  & gammas_Y1_wH[[i]]$C1== c1i  & gammas_Y1_wH[[i]]$X1== x1i,]$gamma<-Y1probB(y1i, c1i, x1i)
...
C2probB<-function(c2,c1,x1,nm=1){
	...
	if(c2==0){return(1-as.numeric(pp))}
	if(c2==1){return(as.numeric(pp))}}
gammas_Y1_wH[[i]][gammas_Y1_wH[[i]]$cond=="C2" & gammas_Y1_wH[[i]]$C2== c2i  & gammas_Y1_wH[[i]]$C1== c1i  & gammas_Y1_wH[[i]]$X1== x1i,]$gamma<-C2probB(c2i, c1i, x1i)
...
Y2probB<-function(y2,c2,x2,y1,nm=1){
	...
	if(y2==0){return(1-as.numeric(pp))}
	if(y2==1){return(as.numeric(pp))}}
gammas_Y1_wH[[i]][gammas_Y1_wH[[i]]$cond=="Y2" & gammas_Y1_wH[[i]]$Y2== y2i  & gammas_Y1_wH[[i]]$C2== c2i  & gammas_Y1_wH[[i]]$X2== x2i  & gammas_Y1_wH[[i]]$Y1== y1i,]$gamma<-Y2probB(y2i, c2i, x2i, y1i)
}}}}}
...
for(c1i in 0:1){
sumtheta11B<-sumtheta11B+
unique(gammas_Y1_wH[[i]][gammas_Y1_wH[[i]]$cond=="C1" & gammas_Y1_wH[[i]]$C1== c1i,]$gamma*
gammas_Y1_wH[[i]][gammas_Y1_wH[[i]]$cond=="Y1" & gammas_Y1_wH[[i]]$Y1== y1i  & gammas_Y1_wH[[i]]$C1== c1i  & gammas_Y1_wH[[i]]$X1== x1i,]$gamma*
gammas_Y1_wH[[i]][gammas_Y1_wH[[i]]$cond=="C2" & gammas_Y1_wH[[i]]$C2== c2i  & gammas_Y1_wH[[i]]$C1== c1i  & gammas_Y1_wH[[i]]$X1== x1i,]$gamma*
gammas_Y1_wH[[i]][gammas_Y1_wH[[i]]$cond=="Y2" & gammas_Y1_wH[[i]]$Y2== y2i  & gammas_Y1_wH[[i]]$C2== c2i  & gammas_Y1_wH[[i]]$X2== x2i  & gammas_Y1_wH[[i]]$Y1== y1i,]$gamma)
}}}
...
sumtheta11Bvec[sw]<-sumtheta11B
sumtheta00Bvec[sw]<-sumtheta00B
gammas[,sw]<-gammas_Y1_wH[[i]]$gamma
}
...
sumtheta00Bvec<-rep(0,nB)
gammas_wY1_H<-list()
gammas_wY1_H[[i]]<-data.frame(expand.grid(c(0,1),c(0,1),c(0,1),c(0,1),c(0,1),c(0,1),c(1), c("H","C1","C2","Y1","Y2"), c(NA)))
colnames(gammas_wY1_H[[i]])<-c("H","C1","C2","X1","X2","Y1","Y2", "cond", "gamma")

gammas<-matrix(0,dim(gammas_wY1_H[[i]])[1], nB)
...
gammas_wY1_H[[i]][gammas_wY1_H[[i]]$cond=="H" & gammas_wY1_H[[i]]$H== h1i,]$gamma<-HprobB(h1i)	           
        ...
        C1probB <- function(h, c1, nm = 1) {
            ...
            if (c1 == 0) {return(1 - as.numeric(pp))}
            if (c1 == 1) {return(as.numeric(pp))}}
gammas_wY1_H[[i]][gammas_wY1_H[[i]]$cond=="C1" & gammas_wY1_H[[i]]$C1== c1i & gammas_wY1_H[[i]]$H== h1i,]$gamma<-C1probB(h1i ,c1i)	
        ...
        C2probB <- function(h, c2, c1, x1, nm = 1) {
            ...
            if (c2 == 0) {return(1 - as.numeric(pp))}
            if (c2 == 1) {return(as.numeric(pp))} }
            gammas_wY1_H[[i]][gammas_wY1_H[[i]]$cond=="C2" & gammas_wY1_H[[i]]$H== h1i & gammas_wY1_H[[i]]$C2== c2i  & gammas_wY1_H[[i]]$C1== c1i  & gammas_wY1_H[[i]]$X1== x1i,]$gamma<-C2probB(h1i, c2i, c1i, x1i)
        ...
        Y2probB <- function(h, y2, c1, c2, x1, x2, nm = 1) {
            ...
            if (y2 == 0) {return(1 - as.numeric(pp))}
            if (y2 == 1) {return(as.numeric(pp))}}
 gammas_wY1_H[[i]][gammas_wY1_H[[i]]$cond=="Y2" & gammas_wY1_H[[i]]$Y2== y2i & gammas_wY1_H[[i]]$C1== c1i   & gammas_wY1_H[[i]]$C2== c2i  & gammas_wY1_H[[i]]$X2== x2i  & gammas_wY1_H[[i]]$X1== x1i,]$gamma<-Y2probB(h1i, y2i, c1i, c2i, x1i, x2i)       
 }}}}}
...
for(c1i in 0:1){
 ...
 sumtheta11B<-sumtheta11B+
unique(gammas_wY1_H[[i]][gammas_wY1_H[[i]]$cond=="H" & gammas_wY1_H[[i]]$H== h1i,]$gamma*
gammas_wY1_H[[i]][gammas_wY1_H[[i]]$cond=="C1" & gammas_wY1_H[[i]]$C1== c1i & gammas_wY1_H[[i]]$H== h1i,]$gamma*
 gammas_wY1_H[[i]][gammas_wY1_H[[i]]$cond=="C2" & gammas_wY1_H[[i]]$H== h1i & gammas_wY1_H[[i]]$C2== c2i  & gammas_wY1_H[[i]]$C1== c1i  & gammas_wY1_H[[i]]$X1== x1i,]$gamma*
 gammas_wY1_H[[i]][gammas_wY1_H[[i]]$cond=="Y2" & gammas_wY1_H[[i]]$Y2== y2i & gammas_wY1_H[[i]]$C1== c1i   & gammas_wY1_H[[i]]$C2== c2i  & gammas_wY1_H[[i]]$X2== x2i  & gammas_wY1_H[[i]]$X1== x1i,]$gamma)
}}}
...
sumtheta11Bvec[sw]<-sumtheta11B
sumtheta00Bvec[sw]<-sumtheta00B
gammas[,sw]<-gammas_wY1_H[[i]]$gamma
}
...
sumtheta00Bvec<-rep(0,nB)
gammas_Y1_H<-list()
gammas_Y1_H[[i]]<-data.frame(expand.grid(c(0,1),c(0,1),c(0,1),c(0,1),c(0,1),c(0,1),c(1), c("H","C1","C2","Y1","Y2"), c(NA)))
colnames(gammas_Y1_H[[i]])<-c("H","C1","C2","X1","X2","Y1","Y2", "cond", "gamma")

gammas<-matrix(0,dim(gammas_Y1_H[[i]])[1], nB)
  ...
  for (x1i in 0:1) {
    ...
    for (h1i in 0:1) {
     ...
     HprobB <- function(h, nm = 1) {
            ...
            if (h == 0) {return(1 - as.numeric(pp))}
            if (h == 1) {return(as.numeric(pp))}}
gammas_Y1_H[[i]][gammas_Y1_H[[i]]$cond=="H" & gammas_Y1_H[[i]]$H== h1i,]$gamma<-HprobB(h1i)	          
      ...
      C1probB <- function(h, c1, nm = 1) {
            ...
            if (c1 == 0) {return(1 - as.numeric(pp))}
            if (c1 == 1) {return(as.numeric(pp))}}
gammas_Y1_H[[i]][gammas_Y1_H[[i]]$cond=="C1" & gammas_Y1_H[[i]]$C1== c1i & gammas_Y1_H[[i]]$H== h1i,]$gamma<-C1probB(h1i ,c1i)	
	 ...
	 Y1probB<-function(h, y1,c1,x1,nm=1){
			...
			if(y1==0){return(1-as.numeric(pp))}
			if(y1==1){return(as.numeric(pp))}}
            gammas_Y1_H[[i]][gammas_Y1_H[[i]]$cond=="Y1" & gammas_Y1_H[[i]]$H== h1i & gammas_Y1_H[[i]]$Y1== y1i  & gammas_Y1_H[[i]]$C1== c1i  & gammas_Y1_H[[i]]$X1== x1i,]$gamma<-Y1probB(h1i, y1i, c1i, x1i)
    ...
    C2probB <- function(h, c2, c1, x1, nm = 1) {
            ...
            if (c2 == 0) {return(1 - as.numeric(pp))}
            if (c2 == 1) {return(as.numeric(pp))}}
            gammas_Y1_H[[i]][gammas_Y1_H[[i]]$cond=="C2" & gammas_Y1_H[[i]]$H== h1i & gammas_Y1_H[[i]]$C2== c2i  & gammas_Y1_H[[i]]$C1== c1i  & gammas_Y1_H[[i]]$X1== x1i,]$gamma<-C2probB(h1i, c2i, c1i, x1i)
	...
	Y2probB<-function(h, y2,c2,x2,y1,nm=1){
			...
			if(y2==0){return(1-as.numeric(pp))}
			if(y2==1){return(as.numeric(pp))}}
 gammas_Y1_H[[i]][gammas_Y1_H[[i]]$cond=="Y2" & gammas_Y1_H[[i]]$H== h1i  & gammas_Y1_H[[i]]$Y2== y2i & gammas_Y1_H[[i]]$C2== c2i   & gammas_Y1_H[[i]]$X2== x2i  & gammas_Y1_H[[i]]$Y1== y1i,]$gamma<-Y2probB(h1i, y2i, c2i, x2i, y1i)       
 }}}}}}
...
for(c1i in 0:1){
 ...
 sumtheta11B<-sumtheta11B+
unique(gammas_Y1_H[[i]][gammas_Y1_H[[i]]$cond=="H" & gammas_Y1_H[[i]]$H== h1i,]$gamma*
gammas_Y1_H[[i]][gammas_Y1_H[[i]]$cond=="C1" & gammas_Y1_H[[i]]$C1== c1i & gammas_Y1_H[[i]]$H== h1i,]$gamma*
gammas_Y1_H[[i]][gammas_Y1_H[[i]]$cond=="C2" & gammas_Y1_H[[i]]$H== h1i & gammas_Y1_H[[i]]$C2== c2i  & gammas_Y1_H[[i]]$C1== c1i  & gammas_Y1_H[[i]]$X1== x1i,]$gamma*
gammas_Y1_H[[i]][gammas_Y1_H[[i]]$cond=="Y1" & gammas_Y1_H[[i]]$H== h1i & gammas_Y1_H[[i]]$Y1== y1i  & gammas_Y1_H[[i]]$C1== c1i  & gammas_Y1_H[[i]]$X1== x1i,]$gamma*
 gammas_Y1_H[[i]][gammas_Y1_H[[i]]$cond=="Y2" & gammas_Y1_H[[i]]$H== h1i  & gammas_Y1_H[[i]]$Y2== y2i & gammas_Y1_H[[i]]$C2== c2i   & gammas_Y1_H[[i]]$X2== x2i  & gammas_Y1_H[[i]]$Y1== y1i,]$gamma)
}}}}
...
#one-sided p-values:
        ...
        kkk <- kkk + 1
    	   ...
    	   true_gammas[[i]]$simgamma_wY1_wH<-rowMeans(my_gammas_wY1_wH[[i]])   
   	   true_gammas[[i]]$simgamma_Y1_wH<-rowMeans(my_gammas_Y1_wH[[i]])   
	   true_gammas[[i]]$simgamma_wY1_H<-rowMeans(my_gammas_wY1_H[[i]])   
	   true_gammas[[i]]$simgamma_Y1_H<-rowMeans(my_gammas_Y1_H[[i]])   
}
